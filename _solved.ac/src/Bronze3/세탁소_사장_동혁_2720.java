...
//구하는 프로그램을 작성하시오. 거스름돈은 항상 $5.00 이하이고,
...
//
//출력
//각 테스트케이스에 대해 필요한 쿼터의 개수, 다임의 개수, 니켈의 개수, 페니의 개수를 공백으로 
//구분하여 출력한다.
//
//예제 입력 1 
//3
...
package Bronze3;
	...
	public class 세탁소_사장_동혁_2720 {
		...
		int t = sc.nextInt();//태스트 케이스의 수를 입력받는다.
		for (int i = 0; i < t; i++) {//테스트 케이스만큼 반복
			int result =sc.nextInt();//거스름돈의 금액을 입력받는다.
			System.out.println(result/25+" "+(result%25)/10+" "+ result%25%10/5+" "+ result%25%10%5/1);
			//거스름돈을 계산하는 식 
		}
	}
