...
class SCV extends TerranUnit implements Runnable{
			...
			case 7:
				...
				while(true){ 
					if(ui.enemy.clan.attacker2VT.size()!=0){
						...
						((StarObject)(ui.enemy.clan.attacker2VT.get(rand))).flag=false;
						((StarObject)(ui.enemy.clan.attacker2VT.get(rand))).target=this;
						((StarObject)(ui.enemy.clan.attacker2VT.get(rand))).vt=ui.clan.workerVT;
						((StarObject)(ui.enemy.clan.attacker2VT.get(rand))).job=3;
						((StarObject)(ui.enemy.clan.attacker2VT.get(rand))).go.resume();
						attack(power+ui.clan.getUpgrade(),attackspeed,ui.enemy.clan.attacker2VT,(StarObject)ui.enemy.clan.attacker2VT.get(rand));
						...
						((StarObject)(ui.enemy.clan.attacker1VT.get(rand))).flag=false;
						((StarObject)(ui.enemy.clan.attacker1VT.get(rand))).target=this;
						((StarObject)(ui.enemy.clan.attacker1VT.get(rand))).vt=ui.clan.workerVT;
						((StarObject)(ui.enemy.clan.attacker1VT.get(rand))).job=3;
						((StarObject)(ui.enemy.clan.attacker1VT.get(rand))).go.resume();
						attack(power+ui.clan.getUpgrade(),attackspeed,ui.enemy.clan.attacker1VT,(StarObject)ui.enemy.clan.attacker1VT.get(rand));
						ui.enemy.clan.setUnit(ui.enemy.clan.attacker1VT.size(),ui.enemy.clan.attacker2VT.size(),ui.enemy.clan.workerVT.size());
						ui.enemy.U_unit.setText(String.valueOf(ui.enemy.clan.getUnit()));
						...
						attack(power+ui.clan.getUpgrade(),attackspeed,ui.enemy.clan.building2VT,(StarObject)ui.enemy.clan.building2VT.get(rand));
						...
						attack(power+ui.clan.getUpgrade(),attackspeed,ui.enemy.clan.building1VT,(StarObject)ui.enemy.clan.building1VT.get(rand));
						ui.enemy.clan.setBuilding(ui.enemy.clan.mainBVT.size(),ui.enemy.clan.building1VT.size(),ui.enemy.clan.building2VT.size(),ui.enemy.clan.building3VT.size());
						...
						attack(power+ui.clan.getUpgrade(),attackspeed,ui.enemy.clan.building3VT,(StarObject)ui.enemy.clan.building3VT.get(rand));
	...
	void makeBarracks(){
		...
		if(ui.clan.getMineral()>=Barracks.cost){
			...
			ui.clan.building1VT.add(new Barracks(ui));
			ui.clan.setBuilding(ui.clan.mainBVT.size(),ui.clan.building1VT.size(),ui.clan.building2VT.size(),ui.clan.building3VT.size());
			condi=(String)getCondition(0);
			if(ui.U_name.getText()==ui.clan.getWorkerName())
				ui.setTB(ui.clan.workerVT);
	...
	void makeFactory(){
		if(ui.clan.getMineral()>=Factory.cost && ui.clan.getGas()>=Factory.gascost){
			...
			ui.clan.building2VT.add(new Factory(ui));
			ui.clan.setBuilding(ui.clan.mainBVT.size(),ui.clan.building1VT.size(),ui.clan.building2VT.size(),ui.clan.building3VT.size());
			condi=(String)getCondition(0);
			if(ui.U_name.getText()==ui.clan.getWorkerName())
				ui.setTB(ui.clan.workerVT);
	...
	void makeSupplyDepot(){
		if(ui.clan.getMineral()>=SupplyDepot.cost){
			...
			ui.clan.building3VT.add(new SupplyDepot(ui));
			ui.clan.setBuilding(ui.clan.mainBVT.size(),ui.clan.building1VT.size(),ui.clan.building2VT.size(),ui.clan.building3VT.size());
			condi=(String)getCondition(0);
			if(ui.U_name.getText()==ui.clan.getWorkerName())
				ui.setTB(ui.clan.workerVT);
