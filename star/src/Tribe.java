...
abstract class Tribe {
	...
	ArrayList building1VT; // 공격생산1건물
	ArrayList attacker1VT; // 공격유닛1
	ArrayList building2VT; // 공격생산2건물
	ArrayList attacker2VT; // 공격유닛2
	ArrayList building3VT; // 건물(최대 만들수있는 유닛 증가 and 업그레이드가능)
	/////////각 건물 및 유닛 아이템(콤보박스)정보 담는 벡터//////
	ArrayList mainBItem;
	ArrayList building1Item;
	ArrayList building2Item;
	ArrayList building3Item;
	ArrayList workerItem;
	ArrayList attacker1Item;
	ArrayList attacker2Item;
	Tribe(StarUI ui){
		this.ui = ui;
		mineral=100; 
		gas=100;
